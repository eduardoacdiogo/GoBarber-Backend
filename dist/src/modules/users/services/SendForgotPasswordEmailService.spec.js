...
describe('SendForgotPasswordEmailService', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmailService = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeUserTokensRepository, fakeMailProvider);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordEmailService.execute({ email: 'john.doe@test.com.br' })];
                case 2:
                    _a.sent();
    ...
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordEmailService.execute({ email: 'john.doe@test.com.br' })).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
