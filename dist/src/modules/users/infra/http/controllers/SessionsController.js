...
var SessionsController = /** @class */ (function () {
    ...
    SessionsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, authenticate, _b, user, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        authenticate = tsyringe_1.container.resolve(AuthenticateUserService_1.default);
                        return [4 /*yield*/, authenticate.execute({
                                email: email,
                                password: password,
                            })];
                    case 1:
